...
pygame.display.set_caption("Stray Balloon")
...
balloon_img = pygame.image.load("10_balloon.png") #balloon object variable, loads the balloon images in the variable


#how to load multiple images in Python through Pygame

balloon_list2 = [pygame.image.load('10_balloon.png'), pygame.image.load('20_balloon.png')]
...
while running: #all of the events below happen when the game is running
    f_counter += 1 #frame counter increases by 1
    if f_counter > 300: #when the frame counter is over 300
        speed += 1 #increases the speed by 1
        f_counter = 0 #reset the frame counter
    ...
    for balloon in balloon_list:
        ...
        balloon[1] -= speed #1 represents Y coordinates and 0 represent X coordinates
